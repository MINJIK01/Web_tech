...
userSchema.pre('save', function( next ){ //mongoose에서 가져온 method로 user모델에 user정보를 저장하기 전에, 미리 무언가를 한다는 의미
...
userSchema.methods.comparePassword = function(plainPassword, cb) {
    ...
    bcrypt.compare(plainPassword, this.password, function(err, isMatch) { //비밀번호 비교하는 method
