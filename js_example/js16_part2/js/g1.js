...
let canvas = document.getElementById('canvas_example'); // global
let context = canvas.getContext('2d');                  // global
...
clearButton.addEventListener("click", function(event) { clearCanvas(); console.log(event); } );
